...
module.exports = function graphUI () {
  ...
  // binds the generci graph creator buttons on the UI
  ...
  // links the graph creator UI with the rest of the app
  phaseMenu('grcGraph')
}

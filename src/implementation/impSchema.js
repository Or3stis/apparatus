...
impMetamodel.micronetArray = ['device', 'net', 'vulnerability', 'micronet']
...
impMetamodel.constraintArray = ['threat']
impMetamodel.mechanismArray = ['vulnerability']
impMetamodel.threatArray = ['asset', 'malicious actor', 'vulnerability', 'constraint',
  'net']

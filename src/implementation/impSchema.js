...
impMetamodel.network = ['device', 'network connection', 'micronet',
  'net', 'unidentified node', 'information', 'application'
]
...
impMetamodel.deviceArray = ['micronet', 'vulnerability',
  'network connection', 'information', 'actor', 'asset', 'device', 'application'
]
impMetamodel.applicationArray = ['device', 'asset', 'information',
  'vulnerability', 'actor', 'malicious actor', 'event sensor', 'report sensor',
  'control sensor'
]
...
impMetamodel.informationArray = ['asset', 'device', 'network connection', 'actor',
  'application'
]
impMetamodel.actorArray = ['asset', 'network connection', 'device',
  'unidentified node', 'information', 'application'
]
impMetamodel.maliciousActorArray = impMetamodel.actorArray.concat('threat')
impMetamodel.assetArray = ['information', 'threat', 'actor', 'device', 'application']
...
impMetamodel.controlSensorArray = ['application', 'event sensor',
  'report sensor', 'mechanism'
]
